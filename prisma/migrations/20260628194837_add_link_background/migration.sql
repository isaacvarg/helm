...
INSERT INTO "new_Link" ("description", "href", "icon", "id", "newTab", "order", "sectionId", "showDescription", "showIcon", "showTitle", "title") SELECT "description", "href", "icon", "id", "newTab", "order", "sectionId", "showDescription", "showIcon", "showTitle", "title" FROM "Link";
DROP TABLE "Link";
