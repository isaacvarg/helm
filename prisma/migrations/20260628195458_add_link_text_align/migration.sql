...
INSERT INTO "new_Link" ("bgColor", "bgImage", "bgOpacity", "description", "href", "icon", "id", "newTab", "order", "sectionId", "showDescription", "showIcon", "showTitle", "title") SELECT "bgColor", "bgImage", "bgOpacity", "description", "href", "icon", "id", "newTab", "order", "sectionId", "showDescription", "showIcon", "showTitle", "title" FROM "Link";
DROP TABLE "Link";
