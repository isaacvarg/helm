...
INSERT INTO "new_Dashboard" ("backgroundImage", "bgOverlayFrom", "bgOverlayOpacity", "bgOverlayTo", "bgOverlayVia", "id", "subtitle", "theme", "title", "titleGradientFrom", "titleGradientTo", "titleGradientVia") SELECT "backgroundImage", "bgOverlayFrom", "bgOverlayOpacity", "bgOverlayTo", "bgOverlayVia", "id", "subtitle", "theme", "title", "titleGradientFrom", "titleGradientTo", "titleGradientVia" FROM "Dashboard";
